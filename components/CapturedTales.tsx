            ...
            <AnimatePresence mode="wait">
                {selectedCouple === 'Aditya & Riya' && (
                    ...
                    >
                        ...
                        <img src="/Images/AdityaAndRiyaMobile.svg" alt="" className='lg:hidden w-full' />
                    </motion.div>
                )}
                ...
                {selectedCouple === 'Maitri & Mihir' && (
                    ...
                    >
                        ...
                        <img src="/Images/MaitriAndMihirMobile.svg" alt="" className='lg:hidden w-full' />
                    </motion.div>
                )}
                ...
                {selectedCouple === 'Priyank & Dwisha' && (
                    ...
                    >
                        ...
                        <img src="/Images/PriyankAndDwishaMobile.svg" alt="" className='lg:hidden w-full' />
                    </motion.div>
                )}
                ...
                {selectedCouple === 'Vikas & Sapna' && (
                    ...
                    >
                        ...
                        <img src="/Images/VikasAndSapnaMobile.svg" alt="" className='lg:hidden w-full' />
                    </motion.div>
                )}
                ...
                {selectedCouple === 'Manav & Karishma' && (
                    ...
                    >
                        ...
                        <img src="/Images/ManavAndKarishmaMobile.svg" alt="" className='lg:hidden w-full' />
                    </motion.div>
                )}
            </AnimatePresence>
        </div>
