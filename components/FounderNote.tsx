    ...
    return (
        <div className="flex lg:flex-row flex-col-reverse text-center relative overflow-hidden lg:px-0 px-5">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="lg:w-[55%] lg:bg-[#777461] lg:pl-10 lg:pr-40 lg:pt-28"
            >
                <div className="lg:text-[#EAE7D8] text-[#34291E] lg:h-[850px] text-left">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="lg:w-[45%]  lg:flex lg:items-start lg:justify-center lg:pt-28"
