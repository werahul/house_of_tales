...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-20 md:px-10">
      <h2 className="text-[47px] mirage text-[#34291E] text-center mb-12">
        LOVE, TOLD BY THEM
      </h2>
      ...
      >
        {visibleTestimonials.map((t, index) => (
          ...
          >
            <img src="/Images/qoutImg.svg" alt="quote" />
      ...
      <div className="flex justify-center mt-5 space-x-1">
        {Array.from({ length: totalPages }).map((_, index) => (
          <button
            ...
            className={`w-[8px] h-[8px] rounded-full transition-all duration-300 ${index === currentPage ? 'bg-[#34291E]' : 'bg-[#C1BFB7]'}`}
          ></button>
        ))}
      </div>
    </section>
